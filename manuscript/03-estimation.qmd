...
#| fig-cap: "**Replication of Fig. 6 in @greenwood2009**."
...
#| fig-cap: "**Replication of Fig. 7 in @greenwood2009**."
sim_long <- simulation |>
  tidyr::pivot_longer(
    cols = c(pm, pd),
    names_to = "variable",
...
```{r}
#| label: fig-benchmark
#| fig-cap: "**Computational Performance of Continuous-Time and Discrete-Time Methods.**"
